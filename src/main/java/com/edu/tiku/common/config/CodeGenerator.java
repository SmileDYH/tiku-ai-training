...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //自动生成代码存放的路径
        gc.setOutputDir("D:\\Develop\\project\\tiku-ai-training" + "/src/main/java");
        //设置 --作者注释
        gc.setAuthor("dyh");
        //是否打开文件夹
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://172.16.1.236:3306/tiku_ai_training?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("baixiao");
        dsc.setPassword("tfedu6188");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc); //把数据源配置加入到代码生成器

        // 3、包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.edu.tiku");
        ...
        //要映射的数据库表名  （重点） 表名，多个英文逗号分割
        strategy.setInclude(scanner("question_original_data,question,option,knowledge,book_chapter").split(","));
        //添加表名前缀
